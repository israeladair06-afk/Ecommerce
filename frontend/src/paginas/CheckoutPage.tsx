...
const CheckoutPage = () => {
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="max-w-md mx-auto text-center">
          ...
          <p className="text-gray-500 mb-8">Necesitas tener una cuenta para realizar tu compra. Si ya tienes una, inicia sesión. Si no, regístrate gratis.</p>

          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link
              to="/login?redirect=/checkout"
              className="flex items-center justify-center gap-2 px-6 py-3.5 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition shadow-lg shadow-blue-200"
            >
              <LogIn size={18} /> Iniciar sesión
            </Link>
            <Link
              to="/registro?redirect=/checkout"
              className="flex items-center justify-center gap-2 px-6 py-3.5 bg-amber-400 text-gray-900 rounded-xl font-semibold hover:bg-amber-500 transition shadow-lg shadow-amber-200"
            >
          ...
          <div className="mt-6 space-y-3">
            <div className="flex items-start gap-3 bg-gray-50 rounded-xl p-4 text-left">
              ...
              <div>
                <p className="text-sm font-semibold text-gray-900">Beneficios de tener una cuenta</p>
                <ul className="text-xs text-gray-500 mt-1 space-y-1">
                  <li>✓ Seguimiento de pedidos en tiempo real</li>
                  <li>✓ Historial de compras completo</li>
          ...
          {/* Productos en carrito (si hay) */}
          {items.length > 0 && (
            <div className="mt-6 bg-white rounded-xl border border-gray-100 p-4 text-left">
              <p className="text-sm font-semibold text-gray-900 mb-2">Productos en tu carrito ({items.length})</p>
              <div className="space-y-2">
                ...
                {items.length > 3 && <p className="text-xs text-gray-400">+{items.length - 3} productos más</p>}
              </div>
            </div>
          )}

          <Link to="/tienda" className="inline-flex items-center gap-2 mt-6 text-sm text-gray-500 hover:text-blue-600 transition">
  ...
  // Si el carrito está vacío y no es pago exitoso
    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-8">Agrega productos al carrito o selecciona "Comprar ahora" en un producto.</p>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 md:p-12 text-center animate-scaleIn">
          ...
          <div className="bg-gray-50 rounded-xl p-6 mb-8 text-left">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-gray-900 capitalize">{paymentMethod === 'tarjeta' ? 'Tarjeta de crédito' : paymentMethod === 'paypal' ? 'PayPal' : 'Transferencia bancaria'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-500">Envío a</span>
                <span className="font-medium text-gray-900 text-right max-w-[200px]">{address.street}, {address.city}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 rounded-xl p-4 mb-8 flex items-start gap-3 text-left">
            ...
            <div>
              ...
              <p className="text-xs text-blue-700 mt-1">Hemos enviado los detalles a <strong>{address.email}</strong>. Puedes seguir tu pedido desde "Mis Pedidos".</p>
            </div>
          </div>

          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link to="/pedidos" className="px-8 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition shadow-lg shadow-blue-200">
              Ver mis pedidos
            </Link>
            <Link to="/tienda" className="px-8 py-3 bg-gray-100 text-gray-700 rounded-xl font-semibold hover:bg-gray-200 transition">
              Seguir comprando
            </Link>
          </div>
        </div>
        ...
        {[
          ...
          <div key={s.num} className="flex items-center">
            <div className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium transition-all ${
              step >= s.num ? 'bg-blue-600 text-white shadow-md' : 'bg-gray-100 text-gray-400'
            }`}>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 animate-fadeIn">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Ingresa los datos para recibir tu pedido</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="md:col-span-2">
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 border-2 rounded-xl text-sm focus:outline-none transition ${
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 border-2 rounded-xl text-sm focus:outline-none transition ${
                      errors.phone ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-500'
                    }`}
                  />
                ...
                <div className="md:col-span-2">
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">
                    <Home size={14} className="inline mr-1" /> Dirección
                  </label>
                  <input
                    type="text"
                    name="street"
                    ...
                    onChange={handleAddressChange}
                    placeholder="Calle, número, colonia, edificio"
                    className={`w-full px-4 py-2.5 border-2 rounded-xl text-sm focus:outline-none transition ${
                      errors.street ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-500'
                    }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 border-2 rounded-xl text-sm focus:outline-none transition ${
                      errors.city ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-500'
                    }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="Panamá"
                    className={`w-full px-4 py-2.5 border-2 rounded-xl text-sm focus:outline-none transition ${
                      errors.state ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-500'
                    }`}
                  />
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-1.5">
                    <Building size={14} className="inline mr-1" /> País
                  </label>
                  <select
                    name="country"
                    value={address.country}
                    onChange={handleAddressChange}
                    className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-xl text-sm focus:outline-none focus:border-blue-500 transition bg-white"
                  >
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="0801"
                    className={`w-full px-4 py-2.5 border-2 rounded-xl text-sm focus:outline-none transition ${
                      errors.zip ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-500'
                    }`}
                  />
              ...
              <div className="mt-8 flex justify-end">
                <button
                  ...
                  className="px-8 py-3 bg-blue-600 text-white rounded-xl font-semibold hover:bg-blue-700 transition shadow-lg shadow-blue-200 flex items-center gap-2"
                >
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
                <button
                  ...
                  className={`flex items-center gap-3 p-4 border-2 rounded-xl transition text-left ${
                    paymentMethod === 'tarjeta' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                  }`}
                >
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                    paymentMethod === 'tarjeta' ? 'border-blue-600' : 'border-gray-300'
                  }`}>
                    {paymentMethod === 'tarjeta' && <div className="w-2.5 h-2.5 bg-blue-600 rounded-full" />}
                  </div>
                  <CreditCard size={24} className="text-blue-600" />
                  <div>
                    <p className="text-sm font-semibold text-gray-900">Tarjeta</p>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Pago rápido</p>
                  </div>
                </button>
                ...
                <button
                  ...
                  className={`flex items-center gap-3 p-4 border-2 rounded-xl transition text-left ${
                    paymentMethod === 'transferencia' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                  }`}
                >
                  <div className={`w-5 h-5 rounded-full border-2 flex items-center justify-center ${
                    paymentMethod === 'transferencia' ? 'border-blue-600' : 'border-gray-300'
                  }`}>
                    {paymentMethod === 'transferencia' && <div className="w-2.5 h-2.5 bg-blue-600 rounded-full" />}
                  </div>
              ...
              {paymentMethod === 'tarjeta' && (
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    >
                      <Smartphone size={12} /> Cargar ejemplo
                    </button>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-5 text-white">
                    ...
                    <div className="flex justify-between text-xs">
                      <div>
                        ...
                        <p className="font-medium">{card.name || 'NOMBRE DEL TITULAR'}</p>
                      </div>
                      <div className="text-right">
                        <p className="opacity-60 mb-0.5">Vence</p>
                        <p className="font-medium">{card.expiry || 'MM/AA'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="md:col-span-2">
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2.5 border-2 rounded-xl text-sm focus:outline-none transition font-mono ${
                          errors.number ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-500'
                        }`}
                      />
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="123"
                        className={`w-full px-4 py-2.5 border-2 rounded-xl text-sm focus:outline-none transition ${
                          errors.cvc ? 'border-red-400 bg-red-50' : 'border-gray-200 focus:border-blue-500'
                        }`}
                      />
              ...
              {paymentMethod === 'paypal' && (
                <div className="bg-blue-50 rounded-xl p-6 text-center">
                  ...
                  <p className="text-sm text-gray-600 mb-4">Serás redirigido a PayPal para completar el pago de forma segura.</p>
                  <div className="bg-white rounded-lg p-4 inline-flex items-center gap-2 shadow-sm">
                    <Smartphone size={20} className="text-blue-500" />
                    <span className="text-sm font-medium text-gray-700">PayPal Checkout</span>
                  </div>
                </div>
              )}
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 animate-fadeIn">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Verifica que todo esté correcto antes de pagar</p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-4">
                ...
                <p className="text-sm text-gray-500 mt-1">{address.phone} | {address.email}</p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-4">
                ...
                <p className="text-sm text-gray-600 capitalize">
                  {paymentMethod === 'tarjeta' ? `Tarjeta terminada en ${card.number.slice(-4)}` : paymentMethod === 'paypal' ? 'PayPal' : 'Transferencia bancaria'}
                </p>
              </div>
              ...
              <div className="bg-gray-50 rounded-xl p-4 mb-6">
                <h3 className="text-sm font-semibold text-gray-900 mb-3 flex items-center gap-1.5">
                  <Package size={14} className="text-blue-600" /> Productos ({items.length})
                </h3>
                <div className="space-y-3">
                  {items.map((item) => (
                    <div key={item.productId} className="flex items-center gap-3">
                      <div className="w-12 h-12 bg-white rounded-lg overflow-hidden shrink-0 border border-gray-200">
                        <img src={item.image} alt={item.name} className="w-full h-full object-cover" />
                      </div>
              ...
              <button
                ...
                className={`w-full py-4 rounded-xl font-bold text-base transition-all shadow-lg flex items-center justify-center gap-2 ${
                  processing
                    ...
                    : 'bg-gradient-to-r from-blue-600 to-indigo-700 text-white hover:from-blue-700 hover:to-indigo-800 shadow-blue-200 active:scale-[0.99]'
                }`}
              >
                {processing ? (
                  <>
              ...
              <p className="text-xs text-gray-400 text-center mt-3">
                Al hacer clic en "Pagar" aceptas nuestros <span className="text-blue-600 cursor-pointer hover:underline">Términos y condiciones</span>
              </p>
              ...
              <div className="mt-4 flex justify-center">
                ...
                >
                  <ArrowLeft size={14} /> Regresar al pago
                </button>
              </div>
            </div>
          )}
          ...
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 sticky top-24">
            ...
            <div className="mt-6 space-y-2">
              <div className="flex items-center gap-2 text-xs text-gray-500">
                <ShieldCheck size={14} className="text-green-500" /> Pago 100% seguro
              </div>
              <div className="flex items-center gap-2 text-xs text-gray-500">
                <Truck size={14} className="text-blue-500" /> Envío protegido
              </div>
              <div className="flex items-center gap-2 text-xs text-gray-500">
                <Lock size={14} className="text-purple-500" /> Datos encriptados
              </div>
            </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              ...
              <div className="flex justify-center gap-3">
                <div className="w-10 h-7 bg-blue-600 rounded flex items-center justify-center text-white text-[8px] font-bold">VISA</div>
                <div className="w-10 h-7 bg-red-600 rounded flex items-center justify-center text-white text-[8px] font-bold">MC</div>
                <div className="w-10 h-7 bg-blue-500 rounded flex items-center justify-center text-white text-[8px] font-bold">PP</div>
                <div className="w-10 h-7 bg-green-600 rounded flex items-center justify-center text-white text-[8px] font-bold">AME</div>
              </div>
            </div>
          </div>
        </div>
